...
tbl_lifetables |> 
  ...
  labs(
    ...
    subtitle = "People born in the year 2000 and after have the highest probability of being alive",
    x = " Year",
...
tbl_lifetables_extended_2022 |> 
 ...
 geom_line()+
  ...
  # Add labels (title, subtitle, x, y, caption)
  labs(
    title = "Probability of a Person Being Alive in 2022",
    subtitle = "People born in the year 2000 and after have the highest probability of being alive",
    x = " Year",
    y = " Probability of Being Alive",
    caption = "Source: Social Security Administration"
...
plot_estimated_age <- function(tbl, my_name, my_sex) {
  tbl |> 
    ...
    labs(
      ...
      subtitle = " The mean age for Annas is 34, and the years with the highest birth of Annas are between 1912 and 1925.",
      x = "Year",
      y = "Number of Births"
    ) +
...
tbl_names_female_top_25 <- tbl_names |>
  ...
  # Remove column nb_births(DO NOT REMOVE,but code below just in case)
  #select(nb_births)
  # Filter only Females
  filter(sex=="F")|>
  # Slice top 25 rows
...
tbl_names_extended_age |> 
  ...
  # Add labels (title, subtitle, x, y)
  labs(
    title = "Percentiles of the Top 25 Female Names with their Age Median",
    subtitle = "Emily has the youngest age median, while Betty has the highest age median",
    x = "Age Median",
    y = "Name"
  ) +
