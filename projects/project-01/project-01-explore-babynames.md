...
tbl_names_popular |> 
  ...
  labs(
    title = 'Most popular baby names in the United States',
    subtitle = 'Emma and Noah are the most popular baby names of the past decade ',
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = "There were more trendy names beginning with {my_letter} for females than for males",
      caption = "Source: Social Security Administration",
      x = "Year",
      y = 'Percentage of Births'
    ) +
...
tbl_names_by_first_and_last_letter |> 
  ...
  labs(
    title="Distribution of percentage of births by last letter and first letter",
    subtitle="The most common first lettter was A ",
    x="First Letter",
    y= "Last Letter"
  ) +
...
tbl_names_vowel_consonant |> 
  ...
  labs(
    ...
    subtitle="The most used combination for females was consonant,vowel, and consonant,consonant for males",
    x="Year",
    y="Percentage of Births")+
